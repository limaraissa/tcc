     ...
     <Header />
      ...
      <h1 className='lg:text-white lg:font-poppins lg:font-bold lg:text-9xl lg:flex  lg:mr-12 lg:ml-100 lg:relative lg:mt-36 hidden sm:block md:block'>BAY<span className='text-vermelho'>MAX!</span></h1>
        <div className='flex  gab-96  '>
          ...
          <p className='flex text-white font-poppins font-light text-2xl relative mr-20 ml-52 z-10 mt-4 mb-4 hidden sm:block md:block'>Assim como no filme Big hero o personagem Baymax <br/> tem o objetivo de auxiliar na sua saúde. O robô vem <br/> com a intenção de tornar seu dia a dia mais prático e<br/> funcional venha conhecer mais.<br/><button className=' bg-vermelho flex lg:text-white lg:text-xl lg:justify-center lg:mr-50 bg-reed	lg:h-24 lg:w-72	lg:text-white lg:font-poppins lg:font-bold lg:rounded-2xl lg:mt-20 hidden sm:block 	'>BAYMAX</button></p>
